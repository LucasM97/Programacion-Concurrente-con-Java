...
public class Demo {
    public static void main(String[] args) {
        ...
        CuentaBancaria cuenta2 = new actividad2.CuentaSueldo();
        ...
        System.out.println("\n----- Se intenta ingresar 70000");

        cuenta4.ingresar(70000);

        System.out.println("\n----- Se intenta pagar servicio");

        cuenta4.pagarServicio();

        System.out.println("\n----- Se intenta pagar servicio");

        cuenta4.pagarServicio();

        System.out.println("\n----- Se intenta cambiar el alias");

        cuenta4.cambiarAlias();
